...
const ROLES = ['Software Engineer', 'Data Analyst', 'ML Engineer', 'Python Developer', 'Backend Developer']

const STATS = [
  { val: '3+', label: 'Fullstack Projects' },
  { val: '5+', label: 'Frameworks' },
  { val: '1',  label: 'UGC NET' },
]

const FOCUS = [
  { color: 'green',  text: 'Python Backend Development' },
  { color: 'cyan',   text: 'Generative AI' },
  { color: 'purple', text: 'Machine Learning' },
]

const CODE_LINES = [
  { t: 'comment',   v: '# Gautam Kumar · Software Engineer' },
  { t: 'blank' },
  { t: 'kw',        v: 'from', rest: ' skills import [' },
  { t: 'str',       v: '  "Software Development",' },
  { t: 'str',       v: '  "Backend Development",' },
  { t: 'str',       v: '  "Data Analysis",' },
      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.content}>
          ...
          <h1 className={styles.name}>
            Gautam<br />
            <span className={styles.nameAccent}>Kumar<span className={styles.dot}>.</span></span>
          </h1>

          <p className={styles.desc}>
            Crafting intelligent systems at the intersection of <br/>
            <em>Software Development · Data Analysis · Machine Learning</em>
          </p>
          ...
          <div className={styles.actions}>
            ...
            <a href="/assets/Gautam_kumar_Resume.pdf" download="Gautam_kumar_Resume.pdf" className="btn-ghost">
              ↓ Download Resume
            </a>
          </div>
