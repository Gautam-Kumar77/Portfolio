    ...
    <section id="projects" ref={ref} className={styles.sec}>
      <div className="section">
        ...
        <div className={styles.grid}>
          {PROJECTS.map(p => (
            <article className={`${styles.card} ${p.ongoing ? styles.featured : ''} reveal`} key={p.id}>
              {p.ongoing && <div className={styles.featTag}>Ongoing</div>}
              ...
              <div className={`${styles.glow} ${p.ongoing ? styles.glowFeat : ''}`} />
            </article>
          ))}
        </div>
      </div>
